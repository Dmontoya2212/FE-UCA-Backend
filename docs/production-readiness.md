...
- Verificar que solo exista la cuenta inicial `SUPERADMIN`, rotar su contraseña antes de operar el
  sistema y aprovisionar monedas mediante el procedimiento administrativo; no existen catálogos
  predeterminados.
